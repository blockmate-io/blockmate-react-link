...
window.Buffer = window.Buffer || require_buffer().Buffer;
var EVENT_MESSAGES = {
  linkConnect: ``,
...
var createLinkModal = ({
  ...
  const createIframe = (url2, accountId, oauthConnectedAccount, step, depositError, includeDefaultJwt = true) => {
    ...
    if (!existingIframe) {
      ...
      let urlWithParams = `${url2}${urlParams}`;
